      ...
      <CardContent className="space-y-4">
        {connectionStatus === 'error' && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Unable to connect to PostgreSQL database. The application requires a working PostgreSQL connection to function properly. Please check your Docker configuration or database settings.
            </AlertDescription>
            <Button 
              variant="outline" 
              size="sm" 
